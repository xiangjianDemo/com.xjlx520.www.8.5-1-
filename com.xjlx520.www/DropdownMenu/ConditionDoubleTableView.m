    ...
    if (tableView == _firstTableView) {
        ...
        switch (indexPath.section) {
            case 0:
            {
                ...
                cell.textLabel.highlightedTextColor = [UIColor orangeColor];//[self colorWithRGB:0x90EE90];
                cell.textLabel.font=[UIFont systemFontOfSize:14];
        ...
        selectLine.backgroundColor = [UIColor orangeColor];//[self colorWithRGB:0x90EE90];

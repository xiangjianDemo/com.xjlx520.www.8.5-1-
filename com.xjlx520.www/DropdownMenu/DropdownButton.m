...
//        button.backgroundColor=[UIColor colorWithWhite:1.0f alpha:0.8];
...
//    [button setImageEdgeInsets:UIEdgeInsetsMake(11, [title sizeWithFont:[UIFont systemFontOfSize:13.0f]].width + padding + 5, 11, 0)];
    [button.titleLabel.text sizeWithAttributes:@{NSFontAttributeName:button.titleLabel.font}];
    ...
    [button setBackgroundColor:[UIColor colorWithWhite:1.0f alpha:0.8f]];
